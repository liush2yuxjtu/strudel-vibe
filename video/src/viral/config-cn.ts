...
export const FPS = 30;
export const DURATION_FRAMES = 1719; // 57.32s @ 30fps (auto)
...
export const SECTIONS: Section[] = [
  ...
  { start: 11.47, accent: "purple", kicker: "第 2 句", prompt: "加一条慵懒的贝斯线", tag: "它真听懂了，还会一层层叠 🎹" },
  { start: 23.78, accent: "hot", kicker: "第 3 句", prompt: "再加点温暖的电钢琴和弦", tag: "一句一句加，越来越好听" },
  { start: 36.19, accent: "neon", kicker: "第 4 句", prompt: "整体更梦幻一点，加点混响", tag: "氛围感直接拉满 ✨" },
  { start: 47.31, accent: "purple", kicker: "彩蛋", prompt: "你甚至能自己改代码——是真的 Strudel", tag: "周末在浏览器里就能玩 🎧" },
];
